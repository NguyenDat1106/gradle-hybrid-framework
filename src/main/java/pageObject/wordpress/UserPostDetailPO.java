...
public class UserPostDetailPO  extends BasePage {
	...
	public boolean isPostInforDisplayedWithPostBody(String postBody) {
		waitForElementVisible(driver, UserPostDetailPageUI.POST_BODY_TEXT, postBody);
		return isElementDisplayed(driver, UserPostDetailPageUI.POST_BODY_TEXT, postBody);
	}
