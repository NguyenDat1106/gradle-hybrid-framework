...
public class HomePageUI {
	...
	public static final String PAGINATION_PAGE_ACTIVED_BY_NUMBER = "xpath=//a[@class='qgrd-pagination-page-link' and text()='%s']";
	...
	public static final String CHECKBOX_BY_COLUM_INDEX_AND_ROW_INDEX = "xpath=//tbody/tr[%s]/td[%s]/input";
