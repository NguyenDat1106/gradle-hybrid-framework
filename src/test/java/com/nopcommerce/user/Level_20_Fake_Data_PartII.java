...
@Listeners
public class Level_20_Fake_Data_PartII extends BaseTest {
	...
	@BeforeClass 
	 public void beforeClass(String browserName, String firstName, String lastName, String Email, String Password, String date,
	...
	this.Email = Email + generateFakeNumber() + "fakemail.com";
